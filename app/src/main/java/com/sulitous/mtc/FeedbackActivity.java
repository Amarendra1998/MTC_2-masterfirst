...
public class FeedbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Feadback");
    ...
    private void onSubmit(boolean payment, double diet, String anm, String mtc) {
        ...
        mRootRef.collection("Feedback").document(uid).collection(timeStamp).add(feedbackHashMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
            public void onSuccess(DocumentReference documentReference) {
                showDialog.cancel();
                Toast.makeText(FeedbackActivity.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
                Intent mine =new Intent(FeedbackActivity.this,MainActivity.class);
                startActivity(mine);
                finish();
            }
